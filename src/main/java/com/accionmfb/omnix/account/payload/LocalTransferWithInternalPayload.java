...
public class LocalTransferWithInternalPayload {
    ...
    @Pattern(regexp = "^(PL([5-6])([0-9]{4}))|(NGN1([0-9]{4})([0-9]{1})([0-9]{3})|NGN1([0-9]{4})([0-9]{1})([0-9]{3})([0]{2})([0-9]{2})|[0-9]{10})$", message = "Debit account must be either 10 Digit Customer Account or NGN account number")
